        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <a href="#" style="padding: 5px;" class="btn btn-success" id="hrefBackUrl" runat="server" title="Back To Search List">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div style="margin-top: 10px;overflow:auto">
                            <ul id="seatDescription" class="list-inline">
                        ...
                        <div style="clear: both; width: 100%; margin-top: 70px;">
                            <input type="button" id="btnShowNew" value="Show Selected Seats" class="btn btn-primary" />
                            <input type="button" id="btnShow" value="Show All" class="btn btn-primary" />
                        </div>
                    </div>
                        ...
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblPerSeat" runat="server" ClientIDMode="Static" Font-Bold="true" Text="0.00"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Amount</td>
                                            <td>
                                                <span><i class="fa fa-rupee"></i></span>
                                                <asp:Label ID="lbltotal" runat="server" ClientIDMode="Static" Font-Bold="true" Text="0.00"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <div style="margin-top: 5%" class="col-lg-12">
                                    ...
                                    <asp:DropDownList ID="ddlBoardingpoints" runat="server" ClientIDMode="Static" CssClass="form-control"></asp:DropDownList>
                                    <br />
                                    <br />
                                    <asp:Label ID="lblDroppingPoints" runat="server" Font-Bold="true" Text="Dropping Points" Style="display: none"></asp:Label>
                                    <asp:DropDownList ID="ddlDroppingpoints" runat="server" CssClass="form-control" Style="display: none">
